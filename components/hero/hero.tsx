...
function Hero({}: Props) {
  ...
  return (
    <div className="h-auto md:h-screen mt-20 md:mt-0 text-white max-w-7xl mx-auto md:items-end md:justify-between justify-start flex flex-col md:flex-row mb-28 md:pb-60 px-4 md:px-0 md:gap-8">
      <div
        ref={ref}
      ...
      >
        <div>
          <span className="text-xl md:text-4xl">
            <p>
              I´m a dedicated full stack developer, passionate about challenges
              and always eager to tackle new projects, bringing innovative ideas
              to life.
            </p>
          </span>
